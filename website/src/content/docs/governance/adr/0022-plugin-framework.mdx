...
plugin.generated_schemas.<Name>  // generated Pydantic model class (e.g. plugin.generated_schemas.Opportunity)
plugin.schemas["<Name>"]         // { native, common, to_common, from_common } — bidirectional transforms
```
...
#
# generated_schemas: typed _Schemas object with attribute access to generated
#     Pydantic model classes (e.g. plugin.generated_schemas.Opportunity).
# schemas: compiled ObjectSchemas dict for bidirectional transforms
#     (e.g. plugin.schemas["Opportunity"].to_common(...)). Distinct from generated_schemas.
@dataclass
