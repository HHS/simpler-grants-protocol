...
// per-item results and errors (see Decision #7). Return shape finalized in #744.
...
// Specific subclasses are defined alongside the implementation in #744 / #745.
