...
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------- |
| appOpens    | [Event](/simpler-grants-protocol/protocol/schemas/fields/event)                                                                           | No       | The date (and time) at which the opportunity begins accepting applications |
| appDeadline | [Event](/simpler-grants-protocol/protocol/schemas/fields/event)                                                                           | No       | The final deadline for submitting applications                             |
| otherDates  | [Record](/simpler-grants-protocol/protocol/schemas/types/other#record)\<[Event](/simpler-grants-protocol/protocol/schemas/fields/event)\> | No       | An optional map of other key dates in the opportunity timeline             |
