...
| Type                                                                      | Description                      |
| ------------------------------------------------------------------------- | -------------------------------- |
| [string](/simpler-grants-protocol/protocol/schemas/types/string#base)     | A sequence of characters         |
| [uuid](/simpler-grants-protocol/protocol/schemas/types/string#identifier) | A universally unique identifier  |
| [url](/simpler-grants-protocol/protocol/schemas/types/string#uri)         | A Uniform Resource Locator (URL) |
