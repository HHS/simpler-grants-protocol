...
| -------- | -------------------------------------------------------------------------------------- | -------- | ----------------------------------------------- |
| amount   | [decimalString](/simpler-grants-protocol/protocol/schemas/types/numeric#decimalstring) | Yes      | The amount of money                             |
| currency | [string](/simpler-grants-protocol/protocol/schemas/types/string#string)                | Yes      | The ISO 4217 currency code (e.g., "USD", "EUR") |
