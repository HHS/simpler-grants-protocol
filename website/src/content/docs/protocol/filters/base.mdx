...
<SchemaFormatTabs
  jsonSchema={{
    file: { path: "website/public/schemas/yaml/DefaultFilter.yaml" },
  }}
  typeSpec={{
    file: {
      path: "specs/lib/core/filters/base.tsp",
      startLine: 70,
      endLine: 83,
    },
  }}
...
<SchemaFormatTabs
  jsonSchema={{
    file: { path: "website/public/schemas/yaml/EquivalenceOperators.yaml" },
  }}
  typeSpec={{
    file: {
      path: "specs/lib/core/filters/base.tsp",
...
<SchemaFormatTabs
  jsonSchema={{
    file: { path: "website/public/schemas/yaml/ComparisonOperators.yaml" },
  }}
  typeSpec={{
    file: {
      path: "specs/lib/core/filters/base.tsp",
...
<SchemaFormatTabs
  jsonSchema={{
    file: { path: "website/public/schemas/yaml/ArrayOperators.yaml" },
  }}
  typeSpec={{
    file: {
      path: "specs/lib/core/filters/base.tsp",
...
<SchemaFormatTabs
  jsonSchema={{
    file: { path: "website/public/schemas/yaml/RangeOperators.yaml" },
  }}
  typeSpec={{
    file: {
      path: "specs/lib/core/filters/base.tsp",
