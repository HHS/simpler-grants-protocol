...
| value    | [string](/simpler-grants-protocol/protocol/schemas/types/string#string)           | Yes      | The value to use for the filter operation |
...
| -------- | --------------------------------------------------------------------------------- | -------- | ----------------------------------------- |
| operator | [StringOperators](/simpler-grants-protocol/protocol/filters/base#stringoperators) | Yes      | The operator to apply to the filter value |
| value    | array of [string](/simpler-grants-protocol/protocol/schemas/types/string#string)  | Yes      | The value to use for the filter operation |
