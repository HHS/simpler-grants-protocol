...
| Field | Type                                                     | Description                                                |
| ----- | -------------------------------------------------------- | ---------------------------------------------------------- |
| `min` | [Money](/simpler-grants-protocol/protocol/fields/money/) | The minimum monetary value to use for the filter operation |
| `max` | [Money](/simpler-grants-protocol/protocol/fields/money/) | The maximum monetary value to use for the filter operation |
