...
| value    | [numeric](/simpler-grants-protocol/protocol/types/numeric#numeric)                        | The value to use for the filter operation |
...
| Property | Type                                                               | Description                              |
| -------- | ------------------------------------------------------------------ | ---------------------------------------- |
| min      | [numeric](/simpler-grants-protocol/protocol/types/numeric#numeric) | The minimum numeric value for this range |
| max      | [numeric](/simpler-grants-protocol/protocol/types/numeric#numeric) | The maximum numeric value for this range |
...
| Property | Type                                                                                                                               | Description                               |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| operator | [ArrayOperators](/simpler-grants-protocol/protocol/filters/base#arrayoperators)                                                    | The operator to apply to the filter value |
| value    | [Array](/simpler-grants-protocol/protocol/types/other#array)\<[numeric](/simpler-grants-protocol/protocol/types/numeric#numeric)\> | The value to use for the filter operation |
