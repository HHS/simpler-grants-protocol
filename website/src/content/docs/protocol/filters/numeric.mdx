...
| Field | Type                                                               | Description                                               |
| ----- | ------------------------------------------------------------------ | --------------------------------------------------------- |
| `min` | [numeric](/simpler-grants-protocol/protocol/types/numeric#numeric) | The minimum numeric value to use for the filter operation |
| `max` | [numeric](/simpler-grants-protocol/protocol/types/numeric#numeric) | The maximum numeric value to use for the filter operation |
...
| `value`    | array of [numeric](/simpler-grants-protocol/protocol/types/numeric#numeric) values | The value to use for the filter operation |
