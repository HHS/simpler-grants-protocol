...
| Latitude  | [number](/protocol/types/numeric#number) | Yes      | The latitude coordinate of the address location.                             |
| Longitude | [number](/protocol/types/numeric#number) | Yes      | The longitude coordinate of the address location.                            |
