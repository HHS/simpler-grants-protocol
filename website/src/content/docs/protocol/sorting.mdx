...
| -------------- | ---------------------------------------------------------------- | ------------------------------------------------------------- |
| `sortBy`       | [unknown](/simpler-grants-protocol/protocol/types/other#unknown) | The field to sort by, should be an enum for individual routes |
| `customSortBy` | [string](/simpler-grants-protocol/protocol/types/string#string)  | An implementation-defined sort key                            |
...
| Parameter      | Type                                                            | Description                        |
| -------------- | --------------------------------------------------------------- | ---------------------------------- |
| `sortBy`       | [string](/simpler-grants-protocol/protocol/types/string#string) | The field to sort by               |
| `customSortBy` | [string](/simpler-grants-protocol/protocol/types/string#string) | An implementation-defined sort key |
| `sortOrder`    | [SortOrder](#sortorder)                                         | The order to sort by               |
