...
| paginationInfo | [PaginationInfo](/protocol/pagination#paginationinfo) | Details about the pagination |
| sortInfo       | [SortInfo](/protocol/sorting#sortinfo)                | The sort order of the items  |
