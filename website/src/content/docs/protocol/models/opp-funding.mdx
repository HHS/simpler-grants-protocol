...
| -------------------- | ------------------------------------------------------------------ | -------- | ----------------------------------------------- |
| totalAmountAvailable | [Money](/simpler-grants-protocol/protocol/fields/money)            | No       | Total amount of funding available               |
| minAwardAmount       | [Money](/simpler-grants-protocol/protocol/fields/money)            | No       | Minimum amount of funding granted per award     |
| maxAwardAmount       | [Money](/simpler-grants-protocol/protocol/fields/money)            | No       | Maximum amount of funding granted per award     |
| minAwardCount        | [integer](/simpler-grants-protocol/protocol/types/numeric#integer) | No       | Minimum number of awards granted                |
| maxAwardCount        | [integer](/simpler-grants-protocol/protocol/types/numeric#integer) | No       | Maximum number of awards granted                |
| estimatedAwardCount  | [integer](/simpler-grants-protocol/protocol/types/numeric#integer) | No       | Estimated number of awards that will be granted |
