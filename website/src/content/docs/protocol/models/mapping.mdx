...
<SchemaTable filePath={frontmatter.mappingConstantFunction.jsonSchema.file.path} />
...
<SchemaTable filePath={frontmatter.mappingSwitchFunction.jsonSchema.file.path} />
