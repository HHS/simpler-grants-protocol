...
| -------- | ---------------------------------------- | --------------------------------------- |
| const    | [string](/protocol/fields/string#string) | A constant value to add to the mapping. |
...
| Property | Type                                     | Description                                                                                    |
| -------- | ---------------------------------------- | ---------------------------------------------------------------------------------------------- |
| field    | [string](/protocol/fields/string#string) | A dot-separated path to a field in the source schema whose value will be added to the mapping. |
...
| -------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| field    | [string](/protocol/fields/string#string)                                              | A dot-separated path to a field in the source schema whose value will be added to the mapping. |
| case     | [Record](/protocol/fields/record#record)\<[unknown](/protocol/fields/other#unknown)\> | A mapping of source field values to desired output values.                                     |
| default  | [unknown](/protocol/fields/other#unknown)                                             | The default value to output if no case matches the source field value.                         |
