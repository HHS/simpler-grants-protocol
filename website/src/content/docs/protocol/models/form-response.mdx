...
| status           | [FormResponseStatus](#formresponsestatus)                                              | Yes      | The status of the form response.             |
...
| createdAt        | [utcDateTime](/protocol/types/date#utcdatetime)                                        | Yes      | The form's creation date.                    |
| lastModifiedAt   | [utcDateTime](/protocol/types/date#utcdatetime)                                        | Yes      | The form's last modified date.               |
...
| Property    | Type                                                    | Required | Description                    |
| ----------- | ------------------------------------------------------- | -------- | ------------------------------ |
| value       | [FormResponseStatusOptions](#formresponsestatusoptions) | Yes      | The form's status.             |
