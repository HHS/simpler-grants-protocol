...
| instructions   | [string](/protocol/types/string#string)                                                 | No       | The instructions for the competition.      |
| status         | [CompetitionStatus](#competitionstatus)                                                 | Yes      | The status of the competition.             |
| keyDates       | [CompetitionTimeline](#competitiontimeline)                                             | Yes      | The key dates in the competition timeline. |
| forms          | [CompetitionForms](#competitionforms)                                                   | Yes      | The forms for the competition.             |
| customFields   | [Record](/protocol/types/object#record)\<[CustomField](/protocol/fields/custom-field)\> | No       | The custom fields for the competition.     |
...
| Property  | Type                                                                       | Required | Description                                    |
| --------- | -------------------------------------------------------------------------- | -------- | ---------------------------------------------- |
| forms     | [Record](/protocol/types/object#record)\<[Form](/protocol/models/form)\>   | Yes      | The forms for the competition.                 |
| validation| [Record](/protocol/types/object#record)\<unknown\>                         | Yes      | The validation rules for the competition forms. |
...
| Property   | Type                                                                       | Required | Description                                   |
| ---------- | -------------------------------------------------------------------------- | -------- | --------------------------------------------- |
| openDate   | [Event](/protocol/fields/event)                                            | Yes      | The start date of the competition.            |
| closeDate  | [Event](/protocol/fields/event)                                            | Yes      | The end date of the competition.              |
| otherDates | [Record](/protocol/types/object#record)\<[Event](/protocol/fields/event)\> | No       | Additional dates in the competition timeline. |
