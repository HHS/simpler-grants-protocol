...
<Tabs>
  ...
  | ----------- | --------------------------------------------------------------------- | -------- | --------------------------------------------------------- |
  | name        | [string](/simpler-grants-protocol/protocol/models/base-types#string) | Yes      | Name of the custom field                                  |
  | type        | [CustomFieldType](#customfieldtype)                                   | Yes      | The JSON schema type to use when de-serializing the value |
  | schema      | [url](/simpler-grants-protocol/protocol/models/base-types#url)       | No       | Link to the full JSON schema for this custom field        |
  | value       | any                                                                   | Yes      | Value of the custom field                                 |
  | description | [string](/simpler-grants-protocol/protocol/models/base-types#string) | No       | Description of the custom field's purpose                 |
  </TabItem>
