...
| customValue | [string](/simpler-grants-protocol/protocol/types/string#string) | No       | The display value for a custom status      |
| description | [string](/simpler-grants-protocol/protocol/types/string#string) | No       | A human-readable description of the status |
