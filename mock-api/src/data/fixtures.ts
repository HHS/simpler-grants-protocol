 ...
 */
export const RESERVED_MISSING_OPPORTUNITY_ID = "00000000-0000-0000-0000-000000000000";
...
export const OPPORTUNITY_FIXTURES: readonly Opportunity[] = Object.freeze([
  ...
  // ---- Carried over from lib/ts-sdk/examples/mock-api-server.ts (id + title) ----
  {
    ...
    description: "A grant program focused on improving STEM education in under-resourced schools.",
    funding: {
  ...
  // ---- Additional records for filter/sort variety ----
  {
    ...
    description: "Expanding high-speed broadband access to unserved rural communities.",
    funding: {
  ...
  },
  {
    ...
    status: { value: "open", description: "Currently accepting applications" },
    description: "Grants to help small businesses recover from economic disruption.",
    funding: {
  ...
  },
  {
    ...
    description: "Funding for coastal communities to build resilience against flooding.",
    funding: {
  ...
  },
  {
    ...
    status: { value: "open", description: "Currently accepting applications" },
    description: "Supporting research and deployment of clean energy technologies.",
    funding: {
  ...
  },
  {
    ...
    description: "Establishing registered apprenticeships in high-demand trades.",
    funding: {
  ...
  },
  {
    ...
    description: "Expanding preventive health services in underserved neighborhoods.",
    funding: {
  ...
  },
  {
    ...
    description: "Preserving local arts, cultural heritage, and historic landmarks.",
    funding: {
...
export function allForVersion(version: Version): Opportunity[] {
  return OPPORTUNITY_FIXTURES.map(opp => shapeOpportunityForVersion(opp, version, "list"));
}
