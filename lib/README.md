...
That dispatch publishes only. It does not re-run Release Please, so it cannot create or modify a release; the Release PR flow above is the only way a release is cut.
